...
function StringToNumArray(str) {
	//Converts a string into an array of ASCII char codes.
...
var MidiWriter = window.MidiWriter = function (config) {
    ...
    if (config) {
        ...
        tracks.forEach(function(track) {
			hexMidi += codes2Str(track.toBytes()); 
		});
...
var MidiEvent = function(params) {
	...
	this.toBytes = function() {
		...
		byteArray.push.apply(byteArray, translateTickTime(this.time));
...
var MidiTrack = function () {
    ...
    this.toBytes = function () {
		...
		var trackBytes = startBytes.concat(lengthBytes, eventBytes, endBytes);		        
